...
public enum HPCAModifier {
    ...
    public final IIconContainer overlay;
    ...
    HPCAModifier(IIconContainer overlay, double computationX, double coolantX, double heatX, double computationY,
        double coolantY, double heatY) {
