...
public class AssemblingLineRecipes implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            (int) TierEU.RECIPE_UXV,
            1,
            new Object[] { ItemList.NanoForge.get(64), new ItemStack(bw_realglas2, 64, 2),
                GTOreDictUnificator.get(OrePrefixes.frameGt, MaterialsUEVplus.Eternity, 64),
                GTOreDictUnificator.get(OrePrefixes.gem, MaterialsUEVplus.GravitonShard, 8),
                ...
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 32, 15),
                CustomItemList.astralArrayFabricator.get(48) },
            new FluidStack[] { GTNLMaterials.SuperMutatedLivingSolder.getFluidOrGas(10290000),
                MaterialsUEVplus.PhononMedium.getFluid(800000), MaterialsUEVplus.PrimordialMatter.getFluid(512000),
                MaterialsUEVplus.MagnetohydrodynamicallyConstrainedStarMatter.getMolten(16000) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { ItemList.Machine_Multi_TranscendentPlasmaMixer.get(64),
                GTModHandler.getModItem(GalacticraftAmunRa.ID, "tile.baseBlockRock", 64, 14),
                CustomItemList.EOH_Infinite_Energy_Casing.get(64), ItemList.Robot_Arm_UXV.get(64),
                ItemList.Electric_Piston_UXV.get(64), ItemList.Emitter_UXV.get(64), ItemList.Sensor_UXV.get(64),
                ...
                ItemList.Black_Hole_Stabilizer.get(16), CustomItemList.astralArrayFabricator.get(32) },
            new FluidStack[] { MaterialsUEVplus.ExcitedDTSC.getFluid(4200000),
                MaterialsUEVplus.MagMatter.getMolten(604800), MaterialsUEVplus.QuarkGluonPlasma.getFluid(4200000),
