    ...
    public void loadRecipes() {
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'C',
                GTModHandler.getModItem(SGCraft.ID, "sgCoreCrystal", 1, 0),
                'D',
                eternityFluidPacket,
                'E',
                ...
                'I',
                GTModHandler.getModItem(GregTech.ID, "gt.metaitem.03", 1, 32177),
                'J',
                universiumFluidPacket,
                'K',
                GTModHandler.getModItem(SGCraft.ID, "stargateRing", 1, 1),
                'L',
                GTModHandler.getModItem(SGCraft.ID, "stargateRing", 1, 0),
                'M',
                ...
                'P',
                GTModHandler.getModItem(SGCraft.ID, "sgChevronUpgrade", 1, 0),
                'Q',
                ...
                'U',
                GTModHandler.getModItem(SGCraft.ID, "rfPowerUnit", 1, 0),
                'V',
                NHItemList.StargateCrystalAncients.getIS(1),
                'W',
                GTModHandler.getModItem(SGCraft.ID, "stargateController", 1, 0),
                'X',
                ...
                '1',
                GTModHandler.getModItem(SGCraft.ID, "sgIrisUpgrade", 1, 0),
                '2',
                ...
                'b',
                GTModHandler.getModItem(EnderIO.ID, "blockCapBank", 1, 0),
                'c',
                GTModHandler.getModItem(AE2FluidCraft.ID, "fluid_storage.Universe", 1, 0),
                'd',
                GTModHandler.getModItem(SGCraft.ID, "sgControllerCrystal", 1, 0),
                'e',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                "pqrstuvwx",
                'A',
                GTModHandler.getModItem(GalacticraftCore.ID, "item.spaceship", 1, 0),
                'B',
                GTModHandler.getModItem(GalacticraftMars.ID, "item.spaceshipTier2", 1, 0),
                'C',
                GTModHandler.getModItem(GalacticraftMars.ID, "item.itemTier3Rocket", 1, 0),
                'D',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier4Rocket", 1, 0),
                'E',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars4", 1, 14),
                'F',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier5Rocket", 1, 0),
                'G',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier6Rocket", 1, 0),
                'H',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier7Rocket", 1, 0),
                'I',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier8Rocket", 1, 0),
                'J',
                GregtechItemList.Large_Steam_Turbine.get(1),
                'K',
                GTModHandler.getModItem(Avaritia.ID, "Cosmic_Meatballs", 1, 0),
                'L',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 8),
                'M',
                ...
                'P',
                GTModHandler.getModItem(Avaritia.ID, "Ultimate_Stew", 1, 0),
                'Q',
                ...
                '2',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars4", 1, 15),
                '3',
                ...
                '8',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars5", 1, 2),
                '9',
                ...
                'j',
                GTModHandler.getModItem(Avaritia.ID, "Akashic_Record", 1, 0),
                'k',
                ...
                'n',
                GTModHandler.getModItem(Avaritia.ID, "Orb_Armok", 1, 0),
                'o',
                ...
                't',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars5", 1, 1),
                'u',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                ":[]^_=?~!",
                'A',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 4),
                'B',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 5),
                'C',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 8),
                'D',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 0),
                'E',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 17),
                'F',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.extraUtilities.singularity", 1, 0),
                'G',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 0),
                'H',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 18),
                'I',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 11),
                'J',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 2),
                'K',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 1),
                'L',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 2),
                'M',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 32),
                'N',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 5),
                'O',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 1),
                'P',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 4),
                'Q',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 16),
                'R',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 1),
                'S',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 20),
                'T',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 7),
                'U',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.projectRed.singularity", 1, 0),
                'V',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 0),
                'W',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 1),
                'X',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 12),
                'Y',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 6),
                'Z',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 9),
                '0',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 15),
                '1',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 2),
                '2',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 0),
                '3',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 3),
                '4',
                GTModHandler.getModItem(SGCraft.ID, "stargateRing", 1, 0),
                '5',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.draconicEvolution.singularity", 1, 0),
                '6',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 7),
                '7',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 30),
                '8',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.draconicEvolution.singularity", 1, 1),
                '9',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 3),
                'a',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 6),
                'b',
                GTModHandler.getModItem(EternalSingularity.ID, "eternal_singularity", 1, 0),
                'c',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 4),
                'd',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 8),
                'e',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 23),
                'f',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 5),
                'g',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 2),
                'h',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 22),
                'i',
                GTNLItemList.CompressedStargateTier4.get(1),
                'j',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 7),
                'k',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 14),
                'l',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 19),
                'm',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 6),
                'n',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 10),
                'o',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 6),
                'p',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 3),
                'q',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 24),
                'r',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 25),
                's',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 15),
                't',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.vanilla.singularity", 1, 1),
                'u',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 26),
                'v',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 2),
                'w',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 11),
                'x',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 6),
                'y',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 10),
                'z',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 21),
                '/',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 4),
                '<',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.vanilla.singularity", 1, 2),
                '>',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 4),
                ';',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 1),
                ':',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 5),
                '[',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 9),
                ']',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 3),
                '^',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 27),
                '_',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 28),
                '=',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 29),
                '?',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.vanilla.singularity", 1, 0),
                '~',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 3),
                '!',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 13));
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'B',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 114),
                'C',
                kubatech.api.enums.ItemList.DEFCChaoticSchematic.get(1),
                'D',
                GTModHandler.getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0),
                'E',
                GTModHandler.getModItem(GalacticraftAmunRa.ID, "item.schematic", 1, 0),
                'F',
                GTModHandler.getModItem(DraconicEvolution.ID, "teleporterMKII", 1, 0),
                'G',
                GTModHandler.getModItem(GalacticraftCore.ID, "item.schematic", 1, 1),
                'H',
                GTModHandler.getModItem(DraconicEvolution.ID, "chaoticCore", 1, 0),
                'I',
                kubatech.api.enums.ItemList.DEFCWyvernSchematic.get(1),
                'J',
                GTModHandler.getModItem(StevesCarts2.ID, "CartModule", 1, 61),
                'K',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 91),
                'L',
                GTModHandler.getModItem(ThaumicEnergistics.ID, "storage.essentia", 1, 4),
                'M',
                GTModHandler.getModItem(SGCraft.ID, "stargateBase", 1, 0),
                'N',
                GTModHandler.getModItem(SGCraft.ID, "stargateRing", 1, 0),
                ...
                'P',
                GTModHandler.getModItem(StevesCarts2.ID, "upgrade", 1, 14),
                'Q',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 93),
                'R',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier8", 1, 0),
                'S',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 4),
                'T',
                ItemList.EnergisedTesseract.get(1),
                'U',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 5),
                'V',
                GTModHandler.getModItem(GalacticraftMars.ID, "item.schematic", 1, 0),
                'W',
                GTModHandler.getModItem(GalacticraftCore.ID, "item.infiniteOxygen", 1, 0),
                'X',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 90),
                'Y',
                GTModHandler.getModItem(Thaumcraft.ID, "ItemEldritchObject", 1, 3),
                'Z',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 2),
                '0',
                GTModHandler.getModItem(ExtraUtilities.ID, "dark_portal", 1, 0),
                '1',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 3),
                '2',
                GTModHandler.getModItem(Botania.ID, "pool", 1, 1),
                '3',
                GTModHandler.getModItem(ProjectRedFabrication.ID, "projectred.fabrication.icchip", 1, 1),
                '4',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 103),
                '5',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier7", 1, 0),
                '6',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 0),
                '7',
                GTBees.combs.getStackForType(CombType.INFINITY),
                '8',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 1),
                '9',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier4", 1, 0),
                'a',
                GTModHandler.getModItem(AE2WCT.ID, "infinityBoosterCard", 1, 0),
                'b',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 69),
                'c',
                GTModHandler.getModItem(Witchery.ID, "ingredient", 1, 96),
                'd',
                GTNLItemList.CompressedStargateTier5.get(1),
                'e',
                ...
                'i',
                GTModHandler.getModItem(Avaritia.ID, "Infinity_Pickaxe", 1, 0),
                'j',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier6", 1, 0),
                'k',
                GTModHandler.getModItem(Botania.ID, "terraPick", 1, 0),
                'l',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier5", 1, 0),
                'm',
                GTModHandler.getModItem(ThaumicTinkerer.ID, "ichorPickGem", 1, 0),
                'n',
                kubatech.api.enums.ItemList.DEFCAwakenedSchematic.get(1),
                'o',
                GTModHandler.getModItem(Witchery.ID, "infinityegg", 1, 0),
                'p',
                GTModHandler.getModItem(DraconicEvolution.ID, "reactorCore", 1, 0));
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'B',
                GTModHandler.getModItem(IndustrialCraft2.ID, "itemPartCircuit", 1, 0),
                'C',
                ...
                'F',
                GTModHandler.getModItem(IndustrialCraft2.ID, "itemPartCircuitAdv", 1, 0),
                'G',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'D',
                GTModHandler.getModItem(Avaritia.ID, "Crystal_Matrix", 1, 0),
                'E',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'G',
                GTModHandler.getModItem(Avaritia.ID, "Endest_Pearl", 1, 0));
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                "BB--B----",
                'A',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 0),
                'B',
                GTModHandler.getModItem(Avaritia.ID, "Crystal_Matrix", 1, 0),
                'C',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 1),
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'D',
                GTModHandler.getModItem(ThaumicBases.ID, "rainbowCactus", 1, 0),
                'E',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                "--AB9BA--",
                'A',
                GTModHandler.getModItem(Botania.ID, "bifrostPerm", 1, 0),
                'B',
                ...
                new ItemStack(Items.dye, 1, 3),
                'T',
                GTModHandler.getModItem(AE2FluidCraft.ID, "fluid_storage_housing", 1, 3),
                'U',
                new ItemStack(Items.dye, 1, 1),
                'V',
                new ItemStack(Items.dye, 1, 5),
