...
public class EternalGregTechWorkshopTextures {
    ...
    public static final UITexture PICTURE_HEAT_SINK_SMALL = TecTechUITextures.PICTURE_HEAT_SINK_SMALL;
    public static final UITexture OVERLAY_BUTTON_POWER_SWITCH_ON = TecTechUITextures.OVERLAY_BUTTON_POWER_SWITCH_ON;
    public static final UITexture OVERLAY_BUTTON_POWER_SWITCH_OFF = TecTechUITextures.OVERLAY_BUTTON_POWER_SWITCH_OFF;
    public static final UITexture OVERLAY_BUTTON_HEAT_ON = TecTechUITextures.OVERLAY_BUTTON_HEAT_ON;

    public static final UITexture BUTTON_CELESTIAL_32x32 = UITexture
        .fullImage(Mods.GregTech.ID, "gui/button/celestial");
    public static final UITexture BUTTON_SPACE_32x16 = UITexture.fullImage(Mods.GregTech.ID, "gui/button/purple");
    public static final UITexture BUTTON_SPACE_PRESSED_32x16 = UITexture
        .fullImage(Mods.GregTech.ID, "gui/button/purple_pressed");
    public static final UITexture BUTTON_BOXED_CHECKMARK_18x18 = UITexture
        .fullImage(Mods.GregTech.ID, "gui/button/boxed_checkmark");
    public static final UITexture BUTTON_BOXED_EXCLAMATION_POINT_18x18 = UITexture
        .fullImage(Mods.GregTech.ID, "gui/button/boxed_exclamation_point");

    public static final UITexture BACKGROUND_SPACE = UITexture.fullImage(Mods.GregTech.ID, "gui/background/space");
    public static final UITexture BACKGROUND_STAR = UITexture.fullImage(Mods.GregTech.ID, "gui/background/star");
    public static final UITexture SLOT_OUTLINE_GREEN = UITexture
        .fullImage(Mods.GregTech.ID, "gui/picture/green_selector");
    public static final UITexture GREEN_CHECKMARK_11x9 = UITexture
        .fullImage(Mods.GregTech.ID, "gui/picture/green_checkmark");

    public static final UITexture OVERLAY_BUTTON_STRUCTURE_CHECK = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/structure_check");
    public static final UITexture OVERLAY_BUTTON_STRUCTURE_CHECK_OFF = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/structure_check_off");
    public static final UITexture OVERLAY_BUTTON_FURNACE_MODE = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/furnace_mode");
    public static final UITexture OVERLAY_BUTTON_FURNACE_MODE_OFF = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/furnace_mode_off");
    public static final UITexture OVERLAY_BUTTON_INPUT_SEPARATION = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/input_separation");
    public static final UITexture OVERLAY_BUTTON_INPUT_SEPARATION_OFF = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/input_separation_off");
    public static final UITexture OVERLAY_BUTTON_BATCH_MODE = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/batch_mode");
    public static final UITexture OVERLAY_BUTTON_BATCH_MODE_OFF = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/batch_mode_off");
    public static final UITexture OVERLAY_BUTTON_RECIPE_LOCKED = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/recipe_locked");
    public static final UITexture OVERLAY_BUTTON_RECIPE_UNLOCKED = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/recipe_unlocked");
    public static final UITexture OVERLAY_BUTTON_VOIDING_OFF = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/voiding_off");
    public static final UITexture OVERLAY_BUTTON_VOIDING_ITEMS = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/voiding_items");
    public static final UITexture OVERLAY_BUTTON_VOIDING_FLUIDS = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/voiding_fluids");
    public static final UITexture OVERLAY_BUTTON_VOIDING_BOTH = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/voiding_both");
    public static final UITexture OVERLAY_BUTTON_FLAG = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/flag");
    public static final UITexture OVERLAY_BUTTON_ARROW_BLUE_UP = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/arrow_blue_up");
    public static final UITexture OVERLAY_CYCLIC_BLUE = UITexture
        .fullImage(Mods.GregTech.ID, "gui/overlay_button/cyclic_blue");

    public static final UITexture PROGRESSBAR_GODFORGE_MILESTONE_BACKGROUND = UITexture
        .fullImage(Mods.GregTech.ID, "gui/progressbar/godforge_milestone/background");
    public static final UITexture PROGRESSBAR_GODFORGE_MILESTONE_BLUE = UITexture
        .fullImage(Mods.GregTech.ID, "gui/progressbar/godforge_milestone/blue");
    public static final UITexture PROGRESSBAR_GODFORGE_MILESTONE_RED = UITexture
        .fullImage(Mods.GregTech.ID, "gui/progressbar/godforge_milestone/red");
    public static final UITexture PROGRESSBAR_GODFORGE_MILESTONE_PURPLE = UITexture
        .fullImage(Mods.GregTech.ID, "gui/progressbar/godforge_milestone/purple");
    public static final UITexture PROGRESSBAR_GODFORGE_MILESTONE_RAINBOW = UITexture
        .fullImage(Mods.GregTech.ID, "gui/progressbar/godforge_milestone/rainbow");
