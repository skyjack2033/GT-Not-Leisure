...
public class SwarmCoreGui extends GTNLControllerUpgradeGui<SwarmCore> {

    private static final String MACHINE_TIER_SYNC_KEY = "swarmCoreMachineTier";

    public SwarmCoreGui(SwarmCore multiblock) {
        super(multiblock);
    }
